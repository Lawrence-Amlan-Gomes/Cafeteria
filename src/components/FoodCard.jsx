export default function FoodCard({ imgUrl, type, price, setCart, cart, quantity }) {
  ...
  const handleClick = () => {
    ...
    setCart({items: items, totalPrice: newPrice});
      ...
      alert("this Food item is out of stock")
    }
  };
  return (
    <div className="w-[18%] m-[1%] h-[300px] border-gray-500 border-2 rounded-md float-left bg-[#0f0e38] hover:bg-[#0d0d29]">
      ...
      <div className="w-full text-center text-xl mt-1">{type} <span className="text-green-600">({quantity})</span></div>
